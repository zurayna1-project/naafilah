...
export default function EditPoemPage() {
  ...
  const fetchPoem = async () => {
    try {
      ...
      if (!response.ok) throw new Error('Puisi tidak ditemukan');
      ...
      toast({
        title: 'Error',
        description: 'Gagal memuat puisi',
        variant: 'destructive',
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await response.json();
      if (!response.ok) throw new Error(data.error || 'Gagal update puisi');

      toast({
        title: 'Berhasil',
        description: 'Puisi berhasil diupdate',
      });
      ...
      toast({
        title: 'Error',
        description: error instanceof Error ? error.message : 'Gagal update puisi',
        variant: 'destructive',
      });
    } finally {
      setSubmitting(false);
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          <Card className="border-2">
            <CardHeader>
              <CardTitle className="font-serif text-2xl">Edit Puisi</CardTitle>
              <CardDescription>Edit puisi dan ganti cover image jika diperlukan</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    placeholder="Ringkasan singkat puisi untuk preview"
                    rows={3}
                  />
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="published">Publikasikan (Tampilkan di website)</Label>
                </div>
